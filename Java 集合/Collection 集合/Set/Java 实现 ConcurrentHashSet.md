Java 中没有直接提供 ConcurrentHashSet 这样的类，可以通过 java.util.concurrent.ConcurrentHashMap 类来间接实现

## Apache Dubbo

```java
//https://github.com/apache/dubbo/blob/master/dubbo-common/src/main/java/org/apache/dubbo/common/utils/ConcurrentHashSet.java
...
- 其实就是仿照 java.util.HashSet 的实现方式
...
- 利用 Collections 的 newSetFromMap 方法实现
